...
class Matrix {
    ...
    public void checktype() {
        ...
        if (a1) {
            type[i] = "Null";
            Null nu = new Null(matrix, r, c, name);
            e.add(nu);
            i++;
        }
        ...
        if (a2) {
            type[i] = "Ones";
            ones on = new ones(matrix, r, c, name);
            f.add(on);
            i++;
        }
        ...
        if (a3) {
            type[i] = "Rectangular";
            rectangular re = new rectangular(matrix, r, c, name);
            g.add(re);
            i++;
        }
        ...
        if (a4) {
            type[i] = "Singular";
            singular so = new singular(matrix, r, c, name);
            k.add(so);
            i++;
        }
        ...
        if (a5) {
            type[i] = "Row";
            row ro = new row(matrix, r, c, name);
            h.add(ro);
            i++;
        }
        ...
        if (a6) {
            type[i] = "Column";
            column co = new column(matrix, r, c, name);
            a.add(co);
            i++;
        }
        ...
        if (a7) {
            type[i] = "Identity";
            identity id = new identity(matrix, r, c, name);
            c1.add(id);
            i++;
        }
        ...
        if (a8) {
            type[i] = "Singleton";
            singleton si = new singleton(matrix, r, c, name);
            j.add(si);
            i++;
        }
        ...
        if (a9) {
            ...
            skew_symmetric sk = new skew_symmetric(matrix, r, c, name);
            l.add(sk);
            i++;
        }
        ...
        if (a10) {
            ...
            upper_triangular up = new upper_triangular(matrix, r, c, name);
            o.add(up);
            i++;
        }
        ...
        if (a11) {
            ...
            lower_triangular lo = new lower_triangular(matrix, r, c, name);
            d.add(lo);
            i++;
        }
        ...
        if (a12) {
            type[i] = "Diagonal";
            diagonal di = new diagonal(matrix, r, c, name);
            b.add(di);
            i++;
        }
        ...
        if (a13) {
            type[i] = "Symmetric";
            symmetric sy = new symmetric(matrix, r, c, name);
            n.add(sy);
            i++;
        }
        ...
        if (a14) {
            type[i] = "Scalar";
            scalar sc = new scalar(matrix, r, c, name);
            i1.add(sc);
            i++;
        }
        ...
        if (a15) {
            type[i] = "Square";
            square sq = new square(matrix, r, c, name);
            m.add(sq);
        }
